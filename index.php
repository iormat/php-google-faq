        ...
        $faqArr = [
            ...
            [
                ...
                "complexAnswer" => [
                    ...
                    "mainArgumentList" => "La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
                    "subArgument" => "Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.",
                    "subArgument2" => "Google LLC, con sede negli Stati Uniti, per il resto del mondo.",
                    "mainArgumentList2" => "La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.",
                    "outro" => "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account."
                ]
            ],
            [
                ...
                for ($i = 0; $i < count($faqArr); $i++) { 
                    ...
                    if(array_key_exists('answers', $faq)) {
                        ...
                        for ($j = 0; $j < count($faq['answers']); $j++) { 
                            $answer = $faq['answers'][$j];
                            echo "<p>" . $answer . "</p>";
                        }
                    }
                    // check if there is a complex answer (list)
                    if(array_key_exists('complexAnswer', $faq)) {
                        // get complex answers
                        $AnswerData = $faq['complexAnswer'];
                        echo "<p>"
                            . $AnswerData['intro'] 
                            . "<ol>"
                                . "<li>" 
                                    . $AnswerData['mainArgumentList']
                                    . "<ul>" 
                                        . "<li>"
                                            . $AnswerData['subArgument']
                                        . "</li>"
                                        . "<li>"
                                            . $AnswerData['subArgument2']
                                        . "</li>"
                                    . "</ul>"
                                . "</li>"
                                    
                                . "<li>"
                                    . $AnswerData['mainArgumentList2'] 
                                . "</li>"
                            . "</ol>" 
                            . $AnswerData['outro']
                        . "</p>";  
